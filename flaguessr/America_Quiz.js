...
let suggestions = new Array ('Antigua and Barbuda', 'Argentina', 'Bahamas', 'Barbados', 'Belize', 'Bolivia',
...
let lowerCount = new Array ('antigua and barbuda', 'argentina', 'bahamas', 'barbados', 'belize', 'bolivia',
                           'brazil', 'canada', 'chile', 'colombia', 'costa rica', 'cuba', 'dominica', 
                           'dominican republic', 'ecuador', 'el salvador', 'grenada', 'guatemala', 'guyana', 
                           'haiti', 'honduras', 'jamaica', 'mexico', 'nicaragua', 'panama', 'paraguay', 'peru', 
                           'saint kitts and nevis', 'saint lucia', 'saint vincent and the grenadines', 'suriname', 
...
var links = new Array ("https://flagcdn.com/h120/ag.png",
...
function finishQuiz(){
    ...
    let percent = score / 35 * 100;
    percent = percent.toFixed(1);
    if (score >= 28){
        h1.innerHTML = "Congratulations!🥳"
        h2.innerHTML = "Excellent, you passed the quiz with a score of " + score + "/35 (" + percent +
        ...
        h1.innerHTML = "Oops!😬"
        h2.innerHTML = "Good try, but you failed the quiz with a score of " + score + "/35 (" + percent +
